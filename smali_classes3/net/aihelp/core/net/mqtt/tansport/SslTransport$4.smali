.class synthetic Lnet/aihelp/core/net/mqtt/tansport/SslTransport$4;
...
.field static final synthetic $SwitchMap$net$aihelp$core$net$mqtt$tansport$SslTransport$ClientAuth:[I
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lnet/aihelp/core/net/mqtt/tansport/SslTransport$4;->$SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus:[I
    ...
    :try_start_1
    sget-object v2, Lnet/aihelp/core/net/mqtt/tansport/SslTransport$4;->$SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus:[I
    ...
    :try_start_2
    sget-object v3, Lnet/aihelp/core/net/mqtt/tansport/SslTransport$4;->$SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus:[I
    ...
    :try_start_3
    sget-object v4, Lnet/aihelp/core/net/mqtt/tansport/SslTransport$4;->$SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus:[I
    ...
    sput-object v4, Lnet/aihelp/core/net/mqtt/tansport/SslTransport$4;->$SwitchMap$javax$net$ssl$SSLEngineResult$Status:[I
    ...
    :catch_5
    :try_start_6
    sget-object v4, Lnet/aihelp/core/net/mqtt/tansport/SslTransport$4;->$SwitchMap$javax$net$ssl$SSLEngineResult$Status:[I
    ...
    sput-object v3, Lnet/aihelp/core/net/mqtt/tansport/SslTransport$4;->$SwitchMap$net$aihelp$core$net$mqtt$tansport$SslTransport$ClientAuth:[I

    :try_start_9
    sget-object v4, Lnet/aihelp/core/net/mqtt/tansport/SslTransport$ClientAuth;->WANT:Lnet/aihelp/core/net/mqtt/tansport/SslTransport$ClientAuth;

    invoke-virtual {v4}, Lnet/aihelp/core/net/mqtt/tansport/SslTransport$ClientAuth;->ordinal()I
    ...
    :catch_9
    :try_start_a
    sget-object v1, Lnet/aihelp/core/net/mqtt/tansport/SslTransport$4;->$SwitchMap$net$aihelp$core$net$mqtt$tansport$SslTransport$ClientAuth:[I

    sget-object v3, Lnet/aihelp/core/net/mqtt/tansport/SslTransport$ClientAuth;->NEED:Lnet/aihelp/core/net/mqtt/tansport/SslTransport$ClientAuth;
    ...
    invoke-virtual {v1}, Lnet/aihelp/core/net/mqtt/tansport/SslTransport$ClientAuth;->ordinal()I
