.class final Lcom/google/android/exoplr2avp/extractor/avi/StreamFormatChunk;
...
.method public constructor <init>(Lcom/google/android/exoplr2avp/Format;)V
    ...
    .line 48
    iput-object p1, p0, Lcom/google/android/exoplr2avp/extractor/avi/StreamFormatChunk;->format:Lcom/google/android/exoplr2avp/Format;
...
.method private static parseBitmapInfoHeader(Lcom/google/android/exoplr2avp/util/ParsableByteArray;)Lcom/google/android/exoplr2avp/extractor/avi/AviChunk;
    .locals 3
    ...
    .line 63
    invoke-static {p0}, Lcom/google/android/exoplr2avp/extractor/avi/StreamFormatChunk;->getMimeTypeFromCompression(I)Ljava/lang/String;
    ...
    invoke-virtual {v1, v0}, Lcom/google/android/exoplr2avp/Format$Builder;->setSampleMimeType(Ljava/lang/String;)Lcom/google/android/exoplr2avp/Format$Builder;

    .line 70
    new-instance v0, Lcom/google/android/exoplr2avp/extractor/avi/StreamFormatChunk;

    invoke-virtual {p0}, Lcom/google/android/exoplr2avp/Format$Builder;->build()Lcom/google/android/exoplr2avp/Format;

    move-result-object p0

    invoke-direct {v0, p0}, Lcom/google/android/exoplr2avp/extractor/avi/StreamFormatChunk;-><init>(Lcom/google/android/exoplr2avp/Format;)V

    return-object v0
.end method

.method public static parseFrom(ILcom/google/android/exoplr2avp/util/ParsableByteArray;)Lcom/google/android/exoplr2avp/extractor/avi/AviChunk;
    .locals 1
    ...
    .line 34
    invoke-static {p1}, Lcom/google/android/exoplr2avp/extractor/avi/StreamFormatChunk;->parseBitmapInfoHeader(Lcom/google/android/exoplr2avp/util/ParsableByteArray;)Lcom/google/android/exoplr2avp/extractor/avi/AviChunk;
    ...
    .line 36
    invoke-static {p1}, Lcom/google/android/exoplr2avp/extractor/avi/StreamFormatChunk;->parseWaveFormatEx(Lcom/google/android/exoplr2avp/util/ParsableByteArray;)Lcom/google/android/exoplr2avp/extractor/avi/AviChunk;
    ...
    .line 40
    invoke-static {p0}, Lcom/google/android/exoplr2avp/util/Util;->getTrackTypeString(I)Ljava/lang/String;
...
.method private static parseWaveFormatEx(Lcom/google/android/exoplr2avp/util/ParsableByteArray;)Lcom/google/android/exoplr2avp/extractor/avi/AviChunk;
    .locals 7
    ...
    .line 78
    invoke-static {v0}, Lcom/google/android/exoplr2avp/extractor/avi/StreamFormatChunk;->getMimeTypeFromTag(I)Ljava/lang/String;
    ...
    .line 87
    invoke-static {v3}, Lcom/google/android/exoplr2avp/util/Util;->getPcmEncoding(I)I
    ...
    .line 90
    invoke-virtual {p0, v5, v6, v4}, Lcom/google/android/exoplr2avp/util/ParsableByteArray;->readBytes([BII)V
    ...
    .line 95
    invoke-virtual {v6, v0}, Lcom/google/android/exoplr2avp/Format$Builder;->setChannelCount(I)Lcom/google/android/exoplr2avp/Format$Builder;
    ...
    .line 98
    invoke-virtual {p0, v3}, Lcom/google/android/exoplr2avp/Format$Builder;->setPcmEncoding(I)Lcom/google/android/exoplr2avp/Format$Builder;
